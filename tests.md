...
| [Chat Composer and Message Rendering](tests/chat-composer-rendering/index.md) | 39 | Composer controls, queued messages, plan mode, Goal management, markdown parsing, file links, attachments, generated images, and visible message rows. |
