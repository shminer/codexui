...
| [Chat Composer and Message Rendering](tests/chat-composer-rendering/index.md) | 38 | Composer controls, queued messages, plan mode, Goal management, markdown parsing, file links, attachments, generated images, and visible message rows. |
...
| [CLI, Network, and Platform](tests/cli-network-platform/index.md) | 19 | CLI startup, dev scripts, npx, Tailscale, Cloudflare tunnels, Windows, Android, Termux, and platform packaging behavior. |
