...
14. In an Android browser, enable its desktop-site mode and repeat steps 11 through 12.
...
- The top-right `X` remains visible and closes the Diff viewer even when an Android browser reports a desktop viewport width.
