...
10. Tap Ctrl and verify its active appearance; tap one direction key and verify Ctrl returns to its inactive appearance immediately.
11. Repeat step 10 with PgUp and PgDn.
...
- Tab, Ctrl, Esc, PgUp, PgDn, and all four direction controls send one input each to the active session.
