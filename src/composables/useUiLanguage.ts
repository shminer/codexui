...
const zhCN: Record<string, string> = {
  ...
  'Context': '上下文',
  'Waiting for token data': '等待 token 数据',
  'Worked for': '耗时',
  'output tokens': '输出 token',
  'Average output tokens per second for the full turn, including tools and waiting.': '整轮平均每秒输出 token，包含工具调用和等待时间。',
  'Prefill is client-observed time to first text; decode measures text streaming; average covers the full turn.': 'Prefill 为客户端观测的首段文本等待时间；decode 统计文本流式输出；average 统计整轮。',
  'prefill TPS': 'prefill TPS',
  'decode TPS': '解码 TPS',
  'avg TPS': '平均 TPS',
  ...
  'Goal': '目标',
  'Goal objective': '目标内容',
  'Set a long-running objective': '设置长期任务目标',
  'Available after the chat is created': '聊天创建后可用',
  'Loading goal…': '正在加载目标…',
  'Could not load goal': '目标加载失败',
  'Time used': '运行时间',
  ...
  'Ask a side question...': '在侧窗聊天中提问...',
  'Side conversation message': '侧窗聊天消息',
